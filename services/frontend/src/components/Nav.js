...
function Nav() {
  ...
  return (
      ...
      <Menu>
        <NavButton next={() => navigate("/assets/page/1")} icon={<IconNav name="icon-laptop"/>} label="Devices" />
      </Menu>

      <Menu>
        <NavButton next={() => navigate("/users/page/1")} icon={<IconNav name="icon-user"/>} label="Users" />
      </Menu>
