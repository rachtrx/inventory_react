...
import { Grid, Button, Collapse, useDisclosure, Box, Flex, Spacer } from '@chakra-ui/react';
import { ChevronUpIcon, ChevronDownIcon } from '@chakra-ui/icons';
import Toggle from '../pages/components/forms/utils/Toggle';
...
const FilterContainer = ({ children }) => {
    ...
    return (
        <Box width="full">
            <Grid ref={containerRef} templateColumns="repeat(auto-fill, 200px)" gap="10px" width="full" mb={4} alignItems="end">
                {mainFilters}
            </Grid>
            <Collapse in={isOpen} animateOpacity>
                <Grid templateColumns="repeat(auto-fill, 200px)" gap="10px" width="full" mb={4}>
                    {subFilters}
                </Grid>
            </Collapse>
            <Flex gap={6}>
