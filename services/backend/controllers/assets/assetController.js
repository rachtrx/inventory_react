...
const { getAssetFilters, getSubTypes, getSortCondition } = require('@/controllers/utils.js');
const { assetFilters } = require('@utils/constants.js')
...
class AssetController extends BaseController {
    ...
    constructor() {
        super()
        this.dtoCallback = assetRow => new AssetDTO(assetRow).setOngoingLoan().setOngoingReservation().deleteLoans()
        this.excelName = "Asset Logs"
    }
