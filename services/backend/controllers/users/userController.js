...
const { getUserFilters, getSortCondition, generateExcel } = require('@/controllers/utils.js');
const { userFilters } = require('@utils/constants.js')
...
class UserController extends BaseController {
    ...
    constructor() {
        super()
        this.dtoCallback = userRow => new UserDTO(userRow).setOngoingLoans().setOngoingReservations().deleteLoans();
        this.excelName = "User Logs"
    }
